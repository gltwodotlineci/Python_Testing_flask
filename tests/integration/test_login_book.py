...
msg1 = "Great-booking complete!"
msg2 = "You can not book more than 12 places for this competition"
msg3 = "Sorry, you do not have enough points to book this competition"
msg4 = "Sorry, not enough places available"
msg5 = "The competition you chose is not available anymore"

@pytest.mark.parametrize("club_name, clb_pts, clb_email, \
                         comp_name, date, comp_plcs, places_req, msg",
                         [("clb1", "20", "exmp@oc.fr", "CompA",
                           "2020-03-27 10:00:00", "15", "2", msg1),
                          ("clb1", "20", "exmp@oc.fr", "CompA",
                           "2020-03-27 10:00:00", "15", "11", msg2),
                          ("clb1", "15", "exmp@oc.fr", "CompA",
                           "2020-03-27 10:00:00", "15", "16", msg3),
                          ("clb1", "6", "exmp@oc.fr", "CompA",
                           "2020-03-27 10:00:00", "2", "3", msg4),
                          ("clb1", "6", "exmp@oc.fr", "CompA",
                           "2020-03-27 10:00:00", "6", "6", msg5)
...
def test_login_book_place(club_email, patch_dt_club, mock_current_user,
    ...
    assert f"Places available: {comp_plcs}" in resp_booking.data.decode('utf-8')
    ...
    if places_req == "2":
        ...
        assert f"Number of Places: {compet['numberOfPlaces']}" in resp_pourchase
